...
class T_kash extends StatefulWidget {
  final String server_sid,server_amountBilled,server_acc_no,oid,payto,paygrp,accno;
  T_kash(this.server_sid,this.server_amountBilled,this.server_acc_no,this.oid,this.payto, this.paygrp, this.accno);

  @override
  _T_kashState createState() => _T_kashState(this.server_sid,this.server_amountBilled,this.server_acc_no,this.oid,this.payto, this.paygrp, this.accno);
}

class _T_kashState extends State<T_kash> {
// access preferences
  String userid;
  ...
  final String server_sid,server_amountBilled,server_acc_no,oid,payto,paygrp,accno;
  _T_kashState(this.server_sid,this.server_amountBilled,this.server_acc_no,this.oid,this.payto, this.paygrp, this.accno);
  @override
    ...
    Future verifyPayment() async {
      try {
        ...
        var response = await http.post(Uri.parse(url),
            body: json.encode({"oid": oid,"sid" : server_sid, "amt_billed" : server_amountBilled, "app_token" : Definitions.app_token,"user_id" : userArrr["id"],"payment_to" : payto, "payment_grp" : paygrp, "account" : accno}));
